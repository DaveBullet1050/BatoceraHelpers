...
from ... import Command
from ...controller import generate_sdl_game_controller_config_system
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        if system.name == "windows_installers":
            ...
            if not system.isOptSet("sdl_config") or system.getOptBoolean("sdl_config"):
                environment.update(
                    {
                        # DMT - customised to pass system, allowing us to read from batocera.conf
                        # and see if DPAD inputs should be skipped or not (to stop constant scrolling
                        # in games like Broforce)
                        "SDL_GAMECONTROLLERCONFIG": generate_sdl_game_controller_config_system(playersControllers, system),
