...
Storage for wheel and pedals:  
<img width="1279" height="959" alt="image" src="https://github.com/user-attachments/assets/7b8b5020-673d-48ad-a4a0-5ee2fd29a5c8" />  
Speakers (2-way, 2 channel with passive xo):
<img width="1279" height="959" alt="image" src="https://github.com/user-attachments/assets/94a2b304-5095-4eec-a9e4-054f7e90fb83" />  
...
- LED DMD Marquee (DIY)
- 2 way speaker design - shared woofer volume (ported), stereo pair with < 100Hz mono summing (via CamillaDSP).  Amp accessible below control panel
- Rear mounted fans - inlet and exhaust with separate on/off rocker switch
- Overall "power on / off" switch (rear of cabinet)
- Flip down control panel access panel (underneath)
- Removable control panel (screwed from underneath)
- Coin acceptor (see [this](https://github.com/DaveBullet1050/BatoceraHelpers/blob/main/README/CoinAcceptor%20README.md) for wiring details
- Various hotkeys, for amplifier volume (up/down), pause emulator, fastforward and rewind, open in emulator virtual keyboard (e.g.for VICE), config menus - details [here](https://github.com/DaveBullet1050/BatoceraHelpers/blob/main/image/Button%20mapping.ods)
...
<img width="784" height="899" alt="image" src="https://github.com/user-attachments/assets/cba701e7-dba5-461b-abea-dbcda6da934f" />  
<img width="1684" height="793" alt="image" src="https://github.com/user-attachments/assets/0dc23169-c5b3-42fa-89f0-7adc23e040bd" />  
<img width="985" height="856" alt="image" src="https://github.com/user-attachments/assets/cec9c3b2-bd80-445b-beee-0459e130325f" />  
